...
func solution(_ X:String, _ Y:String) -> String {
    var tuple: [(String.Element, Int)] = [("9", 0), ("8", 0), ("7", 0), ("6", 0), ("5", 0), ("4", 0), ("3", 0), ("2", 0), ("1", 0), ("0", 0)]
    var copy = Y
    var answer: String = ""
    
    for i in X {
        if copy.contains(i) {
            let index = 9 - Int(String(i))!
            copy.remove(at: copy.firstIndex(of: i)!)
            let value = tuple[index].1
            tuple[index].1 = value + 1
        }
    }
    tuple.forEach {
        answer += String(repeating: $0.0, count: $0.1)
    }
...
solution("5879275893275892378989573289578923578923748932789473298429", "1437448478324789247893274892378497238947892347982384723949832749387479823748932")
