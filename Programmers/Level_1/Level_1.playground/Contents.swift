...
//    var mbtiDic: [Character: Int] = [:]
//    var answer = ""
//
//    zip(survey, choices).forEach {
//        switch $0.1 {
//        case 1...3:
//            mbtiDic[$0.0.first!] = (mbtiDic[$0.0.first!] ?? 0) + 4 - $0.1
//
//        case 5...7:
//            mbtiDic[$0.0.last!] = (mbtiDic[$0.0.last!] ?? 0) + $0.1 - 4
//
//        default: break
//        }
//    }
//
//    (mbtiDic["R"] ?? 0) >= (mbtiDic["T"] ?? 0) ? answer.append("R") : answer.append("T")
//    (mbtiDic["C"] ?? 0) >= (mbtiDic["F"] ?? 0) ? answer.append("C") : answer.append("F")
//    (mbtiDic["J"] ?? 0) >= (mbtiDic["M"] ?? 0) ? answer.append("J") : answer.append("M")
//    (mbtiDic["A"] ?? 0) >= (mbtiDic["N"] ?? 0) ? answer.append("A") : answer.append("N")
//
//    return answer
//}
//
